...
result <- setNames(lapply(c("Stata", "R"), function(point) {
  ...
  audit_logit_rs_joint(f$joint, r$systems$balanced, f$data,
...
saveRDS(result, "../../tests/testthat/fixtures/glmmtmb-logit-rs-balanced-audit.rds")
cat("LOGIT_RS_BALANCED_INDEPENDENT_AUDIT_COMPLETE=1\n")
