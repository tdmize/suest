...
writeLines(c("* Generated from preflight-checked R Laplace fits; these are R starts, not Stata estimates.",
  ...
  "matrix rownames logitrs_r_starts = y1_left y2_right",
  "matrix colnames logitrs_r_starts = x z _cons var_slope var_intercept covariance",
  paste0("scalar logitrs_r_", outcomes, "_ll = ", vapply(r$components[outcomes], function(m) fmt(m$logLik), character(1)))),
  "suest_r_glmmtmb_logit_rs_disjoint_starts.do")
