...
log using suest_r_glmmtmb_nbinom2_ri_crosslang_benchmark_v2.log, replace text name(glmmnb2)
...
import delimited using suest_r_glmmtmb_nbinom2_ri_crosslang_benchmark_v2.csv, clear varnames(1)

* Revision 2: same base outcomes, disjoint models use odd/even groups.
* Original right-half boundary case is retained as a negative R regression.
