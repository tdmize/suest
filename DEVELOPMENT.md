...
The 0.1.6.9000 development pass improves unsupported-specification
messages and documents predictor scaling and numerical marginal-effect
SE checks in `tools/STABILITY-USABILITY-20260925.md`. It preserves the
native glmmTMB covariance and the distinction between independent R
validation and unresolved raw Stata GSEM discrepancies. The 0.1.6
release instructions are complete.
