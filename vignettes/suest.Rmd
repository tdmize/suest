...
The published comparison evaluates a change from age 20 to age 30 with the
other model-matrix columns held at their means. The full acceptance suite
reproduces the following benchmark:
