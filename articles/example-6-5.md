# Example 6.5: Ordered versus multinomial logit
...
For a standard empirical-distribution average, `marginaleffects` can
calculate category-specific changes directly:
...
The published example evaluates a change from age 20 to age 30 with all
other model-matrix columns held at their means. The package’s full
acceptance suite implements that exact delta-method calculation and
reproduces the Stata results:
